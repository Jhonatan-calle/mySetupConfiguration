...
hl.on("hyprland.start", function()
	...
	hl.exec_cmd("/usr/lib/kdeconnect/kdeconnectd --replace")
end)
...
-- Move focus with SUPER + ALT + H/J/K/L
...
-- Screenshot (Guarda en ~/Pictures y copia al portapapeles)
hl.bind(
	mainMod .. " + SHIFT + Print",
	hl.dsp.exec_cmd("sh -c 'grim -g \"$(slurp)\" - | tee Screenshot_$(date +%Y%m%d_%H%M%S).png | wl-copy'")
)
